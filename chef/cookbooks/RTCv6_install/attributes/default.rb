...
default['jts']['response']['location'] = "http://lexdty9150.ecloud.bcsdc.lexington.ibm.com/downloads/CCM6ResponseFile.xml"
default['jts']['response']['file'] = "CCM6ResponseFile.xml"
default['jts']['home'] = "/opt/IBM/CCM60/server"
default['jts']['contentservice'] = "/opt/IBM/CCM60/server/contentservice"
default['jts']['versionedcontentservice'] = "/opt/IBM/CCM60/server/versionedcontentservice"
