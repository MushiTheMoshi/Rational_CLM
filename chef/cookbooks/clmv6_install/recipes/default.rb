...
## Get CLM v6 Installer
execute ">>> Getting CLM6 installer" do
  user "root"
  cwd deploy_dir
...
## Extract CLM v6 Installer
execute ">>> Unzipping  CLM6 Installer" do
  user "root"
  cwd deploy_dir
...
## Get CLM v6 Configuration Files
execute ">>> Getting CLM6 Configuration Files" do
  user "root"
  cwd deploy_dir
