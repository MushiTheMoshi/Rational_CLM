...
## Get CLM v5 Installer
execute "Get CLM5 installer" do
  user "root"
  cwd deploy_dir
...
## Extract CLM v5 Installer
execute "Unzip CLM5 Installer" do
  user "root"
  cwd deploy_dir
...
## Get CLM v5 Configuration Files
execute "Get CLM5 Configuration Files" do
  user "root"
  cwd deploy_dir
...
execute "Unzip configuration files" do
  user "root"
  cwd deploy_dir
...
## Install CLM v5
execute "Install CLMv5" do
  user "root"
  cwd deploy_dir
  command "/opt/IBM/InstallationManager/eclipse/tools/imcl -input #{JTS_RESPONSE_FILE} -accessRights admin -silent -acceptLicense -log CLM_install.log"
  action :run
end
...
execute "Modyfy Paths Repotools" do
  user "root"
  cwd deploy_dir
