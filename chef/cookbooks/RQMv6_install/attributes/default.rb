...
default['jts']['response']['location'] = "http://lexdty9150.ecloud.bcsdc.lexington.ibm.com/downloads/QM6ResponseFile.xml"
default['jts']['response']['file'] = "QM6ResponseFile.xml"
default['jts']['home'] = "/opt/IBM/QM60/server"
default['jts']['contentservice'] = "/opt/IBM/QM60/server/contentservice"
default['jts']['versionedcontentservice'] = "/opt/IBM/QM60/server/versionedcontentservice"
