...
default['db2']['response']['location'] = "http://lexdty9150.ecloud.bcsdc.lexington.ibm.com/downloads/db2server_DM.rsp"
...
default['db2']['response']['file'] = "/opt/IBM/db2tmp/db2server.rsp"
