...
default['jts']['response']['location'] = "http://lexdty9150.ecloud.bcsdc.lexington.ibm.com/downloads/JTS6ResponseFile.xml"
default['jts']['response']['file'] = "JTS6ResponseFile.xml"
default['jts']['home'] = "/opt/IBM/JTS60/server"
default['jts']['contentservice'] = "/opt/IBM/JTS60/server/contentservice"
default['jts']['versionedcontentservice'] = "/opt/IBM/JTS60/server/versionedcontentservice"
